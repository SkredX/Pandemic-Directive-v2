...
RANDOM_POOL = {
    ...
    "e2": { "text": "SITUATION: PRISON OUTBREAK\nThe virus has breached the Maximum Security Wing.", "choices": [{"text": "Release non-violent.", "mods": {"trust": -5, "inf": 2}}, {"text": "Total Lockdown.", "mods": {"trust": -5}}, {"text": "Ignore.", "mods": {"inf": 5, "trust": -10}}] },
    "e3": { "text": "SITUATION: TRANSPORT STRIKE\nThe National Truckers Union is refusing to enter infected zones.", "choices": [{"text": "Pay double wages.", "mods": {"eco": -5}}, {"text": "Deploy Military.", "mods": {"trust": -5}}, {"text": "Arrest leaders.", "mods": {"trust": -15, "eco": -5}}] },
    "e4": { "text": "SITUATION: CELEBRITY HOAX\nA famous pop star is livestreaming that the virus is fake.", "choices": [{"text": "Arrest the star.", "mods": {"trust": -5}}, {"text": "Ignore it.", "mods": {"inf": 5}}, {"text": "Counter-campaign.", "mods": {"eco": -2}}] },
    "e5": { "text": "SITUATION: BLACK MARKET MEDICINE\nGangs are selling stolen ventilators.", "choices": [{"text": "Authorized Raids.", "mods": {"trust": -5}}, {"text": "Buy back stock.", "mods": {"eco": -10}}, {"text": "Legalize & Tax.", "mods": {"eco": 5, "trust": -10}}] },
    "e6": { "text": "SITUATION: FOREIGN SPIES\nAgents caught stealing vaccine data.", "choices": [{"text": "Execute publicly.", "mods": {"trust": 5, "eco": -5}}, {"text": "Trade for supplies.", "mods": {"trust": -10, "eco": 5}}, {"text": "Turn them.", "mods": {"inf": 2}}] },
    "e7": { "text": "SITUATION: BANK RUN\nThousands are lining up at ATMs.", "choices": [{"text": "Freeze withdrawals.", "mods": {"trust": -15}}, {"text": "Print money.", "mods": {"eco": -15}}, {"text": "Bailout.", "mods": {"eco": -10, "trust": -5}}] },
    "e8": { "text": "SITUATION: TEACHERS STRIKE\nTeachers refuse to return to class.", "choices": [{"text": "Close schools.", "mods": {"eco": -5}}, {"text": "Fire teachers.", "mods": {"trust": -10}}, {"text": "Hybrid classes.", "mods": {"eco": -2}}] },
    "e9": { "text": "SITUATION: REFUGEES\nA caravan of 5,000 refugees has arrived.", "choices": [{"text": "Let them in.", "mods": {"inf": 8}}, {"text": "Turn them back.", "mods": {"trust": -5}}, {"text": "Camps.", "mods": {"eco": -5}}] },
    "e10": { "text": "SITUATION: PRICE GOUGING\nPharmacies raising prices 500%.", "choices": [{"text": "Seize stock.", "mods": {"trust": 5, "eco": -2}}, {"text": "Free market.", "mods": {"trust": -10}}, {"text": "Subsidize.", "mods": {"eco": -5}}] },
    "e11": { "text": "SITUATION: RELIGIOUS CULT\nMass prayer gatherings ignoring lockdown.", "choices": [{"text": "Raid compound.", "mods": {"trust": -10, "pop": -1}}, {"text": "Ignore.", "mods": {"inf": 5}}, {"text": "Negotiate.", "mods": {"trust": 2, "inf": 2}}] },
    "e12": { "text": "SITUATION: ZOO ANIMALS STARVING\nSupply lines failed.", "choices": [{"text": "Divert food.", "mods": {"eco": -2}}, {"text": "Euthanize.", "mods": {"trust": -5}}, {"text": "Release.", "mods": {"trust": -2}}] },
    ...
    "e14": { "text": "SITUATION: INTERNET BLACKOUT\nCyber-attack on the capital.", "choices": [{"text": "Restore civilian.", "mods": {"eco": -5}}, {"text": "Prioritize military.", "mods": {"trust": -10}}, {"text": "Blame enemies.", "mods": {"trust": 5, "eco": -2}}] },
    "e15": { "text": "SITUATION: LOOTING WAVE\nRiots in downtown.", "choices": [{"text": "Shoot on sight.", "mods": {"pop": -2, "trust": -20}}, {"text": "Curfew.", "mods": {"eco": -5, "inf": -2}}, {"text": "Let it burn.", "mods": {"eco": -10}}] },
    ...
    "e17": { "text": "SITUATION: CRUISE SHIP DOCKING\nShip off coast with infected.", "choices": [{"text": "Allow docking.", "mods": {"inf": 5, "trust": 5}}, {"text": "Refuse entry.", "mods": {"trust": -5}}, {"text": "Quarantine offshore.", "mods": {"eco": -5}}] },
    "e18": { "text": "SITUATION: TRASH PILEUP\nGarbage piling up.", "choices": [{"text": "Burn it.", "mods": {"pop": -1}}, {"text": "Army engineers.", "mods": {"trust": 5, "eco": -2}}, {"text": "Ignore.", "mods": {"trust": -5, "inf": 2}}] },
    ...
    "e22": { "text": "SITUATION: HACKER ATTACK\nDebt records encrypted.", "choices": [{"text": "Pay ransom.", "mods": {"eco": -10}}, {"text": "Rebuild.", "mods": {"eco": -5, "trust": -5}}, {"text": "Counter-attack.", "mods": {"eco": -8}}] },
    ...
    "e24": { "text": "SITUATION: SPORTING FINALS\nChampionship tomorrow.", "choices": [{"text": "Cancel.", "mods": {"trust": -10, "eco": -5}}, {"text": "Empty stadium.", "mods": {"eco": -2}}, {"text": "Full crowd.", "mods": {"inf": 10, "eco": 10}}] },
    ...
    "e32": { "text": "SITUATION: DATA LEAK\nTrue numbers leaked.", "choices": [{"text": "Deny.", "mods": {"trust": -10}}, {"text": "Apologize.", "mods": {"trust": 5}}, {"text": "Distract.", "mods": {"eco": -5}}] },
...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        try:
            ...
            global_msg = ""
            if DB_STATUS != "ONLINE":
                # SILENTLY IGNORE DB ERRORS IN GAMEPLAY, JUST DON'T SHOW STATS
                pass 
